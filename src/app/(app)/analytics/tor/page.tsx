...
export default async function AnalyticsTorPage({ searchParams }: { searchParams: Promise<Search> }) {
      ...
      <div className="mb-8 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-[var(--muted)]">
            {uploadScope === "all" ? "All TOR rows in the database." : "Filtered to a single upload batch."}
          </p>
        </div>
      </div>
