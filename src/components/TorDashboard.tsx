...
export function TorDashboard({ uploadId }: Props) {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <Kpi title="Events" value={formatInt(data.kpis.eventCount)} subtitle="rows in TOR (after filters)" />
