      ...
      <section className="mt-8 rounded-xl border border-[var(--border)] bg-[var(--card)] p-6 text-sm text-[var(--muted)]">
        ...
        <ul className="mt-3 list-disc space-y-2 pl-5">
          <li>
            ...
            <strong className="text-[var(--foreground)]">Sign up</strong> and use Analytics, Data grid, and Dashboard.
          </li>
          <li>
            ...
            <code className="rounded bg-[var(--background)] px-1 text-[var(--foreground)]">{`{ "role": "admin" }`}</code> → save. They then see the{" "}
            <strong className="text-[var(--foreground)]">Admin</strong> link in the menu.
          </li>
          <li>
